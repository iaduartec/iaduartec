...
- Task 6: in progress — final publication audit found 37 MB of tracked Portfolio n8n backups, stale Mission Bridge state/docs, and a credential-bearing/stale Oracle snapshot; all are removed locally and ignored, but remote default branches still retain their pre-cleanup copies.
- Task 7: in progress — local remediation and runtime verification are green; final completion is pending safe reconciliation/publication review of divergent remotes and explicit handling of historical credentials.
